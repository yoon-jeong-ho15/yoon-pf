...
export default function NoteFrontmatter({
  ...
  return (
    <div
      className={`flex flex-col gap-1 py-2 px-5 items-center justify-center divide-y border rounded-full text-xs
        bg-amber-100 shadow-gray-700 shadow-[2px_2px_0_1px] min-w-16 max-w-full`}
    >
      <div
